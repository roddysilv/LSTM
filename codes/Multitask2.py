# -*- coding: utf-8 -*-
"""
Created on Tue Aug 10 13:58:28 2021
...
def read(DataFrame,n_in,n_out,n_media,n_col):
    ...
    drop = [i for i in range(-(n_col+1),-DataFrame.shape[1]-1,-1)]
...
def LSTM_run(res,DataFrame,batch_size,epochs,patience,n_in,n_out,n_media,n_col):

    try: DataFrame.pop('weather')
    except: pass

    train_X, test_X, train_y, test_y , dates_train, dates_test= read(DataFrame,n_in,n_out,n_media,n_col)
...
LSTM_run(res,df,batch_size,epochs,patience,n_in,n_out,n_media,n_col)
